...
} from "./chunk-A5FXSST7.js";
import "./chunk-YF6FYSEY.js";
import "./chunk-2H4FM2II.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-U4JE4ORI.js";
...
import {
  ...
  useTheme,
  useThemeProps
} from "./chunk-W7KKN6YD.js";
import "./chunk-WRD5HZVH.js";
import {
  createSvgIcon,
  init_utils
} from "./chunk-HUDFN74F.js";
import "./chunk-2BMCL3I6.js";
import {
  require_createStyled,
  styled_default
} from "./chunk-CUWSVFE7.js";
import {
  clsx_default,
  init_clsx,
  require_prop_types
} from "./chunk-H2YHEN36.js";
import {
...
var usePickerActionsContext = () => {
  const value = React6.useContext(PickerActionsContext);
  if (value == null) {
...
function useValidation(options) {
  ...
  const adapter = usePickerAdapter();
  const previousValidationErrorRef = React9.useRef(validator.valueManager.defaultErrorState);
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React11.useMemo(() => _extends({}, internalProps, validationProps, {
...
var PickerPopperPaperWrapper = React13.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function PickerPopper(inProps) {
  ...
  const ownerState = React13.useMemo(() => _extends({}, pickerOwnerState, {
...
function useOrientation(views, customOrientation) {
  const [orientation, setOrientation] = React17.useState(getOrientation);
  useEnhancedEffect_default(() => {
    const eventHandler = () => {
...
var useControlledValue = ({
  ...
  const inputTimezone = React18.useMemo(() => valueManager.getTimezone(adapter, valueWithInputTimezone), [adapter, valueManager, valueWithInputTimezone]);
  ...
  const valueWithTimezoneToRender = React18.useMemo(() => valueManager.setTimezone(adapter, timezoneToRender, valueWithInputTimezone), [valueManager, adapter, timezoneToRender, valueWithInputTimezone]);
...
function useValueAndOpenStates(parameters) {
  ...
  const {
    current: defaultValue
  } = React19.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React19.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React19.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React20.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React20.useState(null);
  const popupRef = React20.useRef(null);
  const fieldRef = React20.useRef(null);
  const rootRefObject = React20.useRef(null);
  ...
  const ownerState = React20.useMemo(() => ({
  ...
  const triggerStatus = React20.useMemo(() => {
  ...
  const contextValue = React20.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React20.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React20.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React21.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React22.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React23.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime8.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime8.jsxs)(React23.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime8.jsxs)(React23.Fragment, {
...
var useFieldState = (parameters) => {
  ...
  const localizedDigits = React26.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React26.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  const getSectionsFromValue = React26.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    adapter,
  ...
  const parsedSelectedSections = React26.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  ...
  const areAllSectionsEmpty = React26.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  const hasPartiallyFilledSectionsOnBlur = React26.useMemo(() => {
  ...
  const sectionToUpdateOnNextInvalidDateRef = React26.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React27.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React27.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React28.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React29.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React29.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React30.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React30.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React31.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React31.useMemo(() => ({
  ...
  React31.useImperativeHandle(unstableFieldRef, () => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel2(value);
  const sections = React32.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React32.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React32.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React32.useEffect(() => {
...
function useFieldOwnerState(parameters) {
  ...
  const isRtl = useRtl();
  return React35.useMemo(() => _extends({}, pickerOwnerState, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React36.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React36.Fragment, {
  children: [(0, import_jsx_runtime10.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime10.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
function PickersSection(props) {
  ...
  const sectionContentRef = React37.useRef(null);
  ...
  return (0, import_jsx_runtime11.jsxs)(Section, _extends({}, sectionProps, {
    children: [(0, import_jsx_runtime11.jsx)(SectionSeparator, _extends({}, sectionSeparatorBeforeProps)), (0, import_jsx_runtime11.jsx)(SectionContent, _extends({}, sectionContentProps, {
      ref: handleSectionContentRef,
      onBlur: handleContentBlur
    })), (0, import_jsx_runtime11.jsx)(SectionSeparator, _extends({}, sectionSeparatorAfterProps))]
  }));
}
...
var PickersSectionList = React37.forwardRef(function PickersSectionList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersSectionList"
  });
  ...
  React37.useImperativeHandle(sectionListRef, () => ({
    getRoot() {
  ...
  return (0, import_jsx_runtime11.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime11.jsx)(React37.Fragment, {
...
var PickerTextFieldOwnerStateContext = React38.createContext(null);
if (true) PickerTextFieldOwnerStateContext.displayName = "PickerTextFieldOwnerStateContext";
var usePickerTextFieldOwnerState = () => {
  const value = React38.useContext(PickerTextFieldOwnerStateContext);
  if (value == null) {
...
var PickersInputBase = React39.forwardRef(function PickersInputBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInputBase"
  });
  ...
  const activeBarRef = React39.useRef(null);
  const sectionOffsetsRef = React39.useRef([]);
  const handleRootRef = useForkRef(ref, rootRef);
...
var PickersOutlinedInput = React41.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersOutlinedInput"
  });
  ...
  return (0, import_jsx_runtime14.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime14.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime14.jsxs)(React41.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var PickersFilledInput = React42.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
...
var PickersInput = React43.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React44.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  const ownerState = React44.useMemo(() => _extends({}, fieldOwnerState, {
...
var PickerFieldUIContext = React45.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const translations = usePickerTranslations();
  const pickerContext = useNullablePickerContext();
  const pickerFieldUIContext = React45.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!(textFieldInputProps == null ? void 0 : textFieldInputProps.startAdornment) && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    additionalTextFieldInputProps.startAdornment = (0, import_jsx_runtime18.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
  ...
  if (!(textFieldInputProps == null ? void 0 : textFieldInputProps.endAdornment) && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime18.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
  ...
  if (!(additionalTextFieldInputProps == null ? void 0 : additionalTextFieldInputProps.endAdornment) && !(additionalTextFieldInputProps == null ? void 0 : additionalTextFieldInputProps.startAdornment) && pickerFieldUIContext.slots.inputAdornment) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime18.jsx)(InputAdornment, _extends({}, endInputAdornmentProps));
  }
...
var DateField = React46.forwardRef(function DateField2(inProps, inRef) {
  ...
  return (0, import_jsx_runtime19.jsx)(PickerFieldUIContextProvider, {
    slots,
    slotProps,
    inputRef: other.inputRef,
    children: (0, import_jsx_runtime19.jsx)(PickerFieldUI, {
      fieldResponse,
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React48.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
var _excluded27 = ["autoFocus", "className", "currentMonth", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime32.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime32.jsx)(Field, _extends({}, fieldProps, {
      slots: _extends({}, slots, fieldProps.slots),
      slotProps: _extends({}, slotProps, fieldProps.slotProps),
      inputRef
    })), (0, import_jsx_runtime32.jsx)(PickersModalDialog, {
      slots,
      slotProps,
